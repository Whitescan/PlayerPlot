            ...
            if (args.length > 0) {
                ...
                try {
                    ...
                    if (sender instanceof Player) {
                        ...
                        sender.sendMessage(ChatColor.RED + Message.MISC_FORMAT.fromFormat("/plotdeed [" + Message.ARG_PLAYER + "] [" + Message.ARG_AMOUNT + "]"));
                    }
                } catch (Exception e) {
                    ...
                    if (player != null) {
                        ...
                        sender.sendMessage(ChatColor.LIGHT_PURPLE + Message.SUCCESS_ITEMS_SENT.fromPlayer(player.getName()));
                    } else {
