...
public class InteractableIdentifier_V1_13 implements IInteractableIdentifier {
    ...
    private static ImmutableSet<Material> interactableBlocks = ImmutableSet.<Material>builder()
            ...
            .add(WHITE_BED).add(ORANGE_BED).add(MAGENTA_BED).add(LIGHT_BLUE_BED).add(YELLOW_BED).add(LIME_BED).add(PINK_BED).add(GRAY_BED)
            .add(LIGHT_GRAY_BED).add(CYAN_BED).add(PURPLE_BED).add(BLUE_BED).add(BROWN_BED).add(GREEN_BED).add(RED_BED).add(BLACK_BED)
